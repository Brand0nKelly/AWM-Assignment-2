    ...
    return (
        <div className="App">
            <div className="container-fluid">
                <div className="row">
                <h1 className="alert alert-danger">Login To View Map</h1>
                <br />
                <br />

                <div className="col-sm-4">
                    {isLogin ? <h3>Enter Login Details</h3> : <h3>Register Here</h3>}    
            ...
            <div>
                ...
                <p>Register Your Account</p><button onClick={() => setLogin(false)} className="btn btn-primary">Register</button></div> 
            :
            <div>
                <button onClick={RegisterBtn} className="btn btn-primary">Register</button>
<p>Login to Your Account <button className="btn btn-primary" onClick={() => setLogin(true)}>Login</button></p></div>
            }
            </div>
            </div>
